...
public final class UrlConstants {
    ...
    public static final String URL_BOARD_RESCUED_ANIMAL_DETAIL = URL_BOARD_RESCUED_ANIMAL_ROOT + "/detail";
    public static final String URL_BOARD_RESCUED_ANIMAL_MODIFY = URL_BOARD_RESCUED_ANIMAL_ROOT + "/modify";
    public static final String URL_BOARD_RESCUED_ANIMAL_DELETE = URL_BOARD_RESCUED_ANIMAL_ROOT + "/delete";
